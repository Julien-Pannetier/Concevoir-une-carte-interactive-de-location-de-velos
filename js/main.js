$(function() {
  ...
  const station = new Station("brisbane", "041b1c06fd60ac243abd1cadf02347e0fe8a5103", carte);
  const reservation = new Reservation(station);
  const canvas = new Canvas(document.querySelector("#stations__canvas"), document.querySelector("#stations__canvas").getContext('2d'), 400, 400, "black", 5, "round", "round");
